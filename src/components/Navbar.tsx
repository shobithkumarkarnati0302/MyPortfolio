...
import { Menu, X, Github, Linkedin, Code2, Sun, Moon } from "lucide-react";
  ...
  return (
    <nav
      className={cn(
        ...
        scrolled
          ? "bg-white/95 shadow-md backdrop-blur-sm dark:bg-portfolio-dark/95 py-2"
          : "bg-transparent py-4",
      )}
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        <a
          href="#"
          className="text-2xl font-bold text-portfolio-primary flex items-center gap-2 transition-transform duration-300 hover:scale-105"
        >
          <Code2
            className={cn("w-6 h-6", scrolled ? "animate-spin-slow" : "")}
          />
        ...
        <div className="hidden md:flex items-center gap-8 animate-fade-in">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={toggleTheme}
              className="ml-2 p-2 rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
